 ...
 * @Copyright: 2018
 */
public class MyClassIndicatorAdapter extends CommonNavigatorAdapter {
    private List<TagsBean> mData;
    private ViewPager pager;

    public MyClassIndicatorAdapter(List<TagsBean> mData, ViewPager pager) {
    ...
    public IPagerTitleView getTitleView(Context context, final int index) {
        TagsBean tagsBean = mData.get(index);
        SimplePagerTitleView view = new SimplePagerTitleView(context);
        view.setText(tagsBean.getTagname());
        view.setNormalColor(context.getResources().getColor(R.color.text_fu_color));
        view.setSelectedColor(context.getResources().getColor(R.color.red_text));
        view.setTextSize(16);
