package com.xuechuan.xcedu.live.player;
...
import com.xuechuan.xcedu.live.ad.PolyvBitAdapter;
...
public class PolyvPlayerMediaController extends PolyvLiveMediaController implements View.OnClickListener {
    ...
    public void initConfig(final ViewGroup parentView, boolean usePopupWindow) {
        ...
        this.view = LayoutInflater.from(getContext()).inflate(R.layout.polyv_controller_media_port_live, usePopupWindow ? null : this);
        if (usePopupWindow) {
    ...
    public void setBarrageIsShow(int id) {
        iv_dmswitch.setSelected(false);
        iv_dmswitch.setVisibility(id);
        resetDmSwitchView();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.live_bit_name:
                ...
                liveBitLayout.setVisibility(GONE);
                break;
            case R.id.live_float_bitrate_select_layout:
                updateBottomView();
                break;
            case R.id.live_bitrate_popup_definition:
