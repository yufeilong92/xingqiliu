package com.xuechuan.xcedu.live.util;
...
public class PolyvFaceManager {
	...
	private void initFaceMap() {
		...
		mFaceMap.put("[清除1]", R.drawable.polyv_emotion_del_normal);
		...
		mFaceMap.put("[清除2]", R.drawable.polyv_emotion_del_normal);
		...
		mFaceMap.put("[清除3]", R.drawable.polyv_emotion_del_normal);
		...
		mFaceMap.put("[清除4]", R.drawable.polyv_emotion_del_normal);
		...
		mFaceMap.put("[清除5]", R.drawable.polyv_emotion_del_normal);
	}
