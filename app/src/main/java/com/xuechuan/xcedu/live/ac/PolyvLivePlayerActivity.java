package com.xuechuan.xcedu.live.ac;
...
import com.xuechuan.xcedu.live.fg.PolyvChatFragment;
import com.xuechuan.xcedu.live.fg.PolyvDanmuFragment;
import com.xuechuan.xcedu.live.fg.PolyvTabFragment;
import com.xuechuan.xcedu.live.fg.PolyvTabViewPagerFragment;
import com.xuechuan.xcedu.live.playback.activity.PolyvPPTPbPlayerActivity;
import com.xuechuan.xcedu.live.playback.activity.PolyvPbPlayerActivity;

import com.xuechuan.xcedu.live.player.PolyvPlayerAuxiliaryView;
import com.xuechuan.xcedu.live.player.PolyvPlayerLightView;
import com.xuechuan.xcedu.live.player.PolyvPlayerMediaController;
import com.xuechuan.xcedu.live.player.PolyvPlayerVolumeView;
import com.xuechuan.xcedu.live.util.AdmasterSdkUtils;
import com.xuechuan.xcedu.live.util.PolyvKickAssist;
import com.xuechuan.xcedu.live.util.PolyvMarqueeUtils;
import com.xuechuan.xcedu.live.util.PolyvScreenUtils;
...
public class PolyvLivePlayerActivity extends FragmentActivity {
    ...
    private String userId, channelId, chatUserId, nickName, hearicom;
    // 聊天室管理类
    ...
    private String nikeImger = "http://b-ssl.duitang.com/uploads/item/201501/25/20150125094238_mGr2d.jpeg";
...
//        AdmasterSdk.init(getApplicationContext(), "");
        ...
        hearicom = getIntent().getStringExtra("hearicon");
...
//        videoView.getVideoDefinitions(params);
    ...
    private void findIdAndNew() {
        ...
        // TODO: 2018/10/10  设置显示弹幕
        mediaController.setBarrageIsShow(View.GONE);
        // 设置跑马灯
    ...
    public static Intent newIntent(Context context, String userId, String channelId, String chatUserId, String nickName, String hearicon, boolean isLandscape, boolean isToOtherLivePlayer) {
        Intent intent = new Intent(context, PolyvLivePlayerActivity.class);
        intent.putExtra("userId", userId);
        intent.putExtra("channelId", channelId);
        intent.putExtra("chatUserId", chatUserId);
        intent.putExtra("nickName", nickName);
        intent.putExtra("hearicon", hearicon);
        intent.putExtra("isLandscape", isLandscape);
        intent.putExtra("isToOtherLivePlayer", isToOtherLivePlayer);
        return intent;
    }
    ...
    public void onAttachFragment(Fragment fragment) {
        ...
        if (fragment == polyvChatFragment) {
            if (StringUtil.isEmpty(hearicom) || hearicom.equals("null"))
                chatManager.login(chatUserId, channelId, nickName);
            else
                chatManager.login(chatUserId, channelId, nickName, hearicom);
        }
    }
