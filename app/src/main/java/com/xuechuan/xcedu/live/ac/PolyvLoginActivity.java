...
import com.xuechuan.xcedu.live.Permission.PolyvPermission;
...
import com.xuechuan.xcedu.live.view.PolyvPopupWindow;
...
/*        et_userid.setText("");
        ...
        et_channelid.setText("243230");
        et_userid.setText("d740a56357");
...
//                break;
        /*    case PolyvPopupWindow.playbacklist:
            ...
            case PolyvPopupWindow.auto:
                progress.show();
                // 获取直播/回放信息
                livePlayback.getLivePlayback(DataMessageVo.appId, DataMessageVo.appSecret, userId, channelId, new PolyvLivePlaybackListener() {
                    @Override
